...
{:else if page.path === '/sign-up'}     
    <Container>
        <form method="post" action="?/signup" class="flex flex-col space-y-4">
            ...
            <div class="flex flex-col space-y-2">
                <label for="password" class="font-bold">Password</label>
                <input type="password" name="password" class="border border-gray-300 rounded-md p-2" required/>
            </div>
            <div class="flex flex-col space-y-2">
                <label for="password_confirm" class="font-bold">Confirm Password</label>
                <input type="password" name="password_confirm" class="border border-gray-300 rounded-md p-2" required/>
            </div>
